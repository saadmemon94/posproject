                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-info btn-round text-white pull-right"
                                href="{{ route('customer.create') }}">{{ __('Add Customer') }}</a>
        ...
        $(document).ready(function() {
            var dt = $('#customerTable').DataTable({
                ...
                columns: [
                    ...
                    {
                        className: 'dt-body-center',
                        data: 'customer_shop_info',
                        name: 'customer_shop_info'
                    },
                    ...
                    {
                        className: 'dt-body-center',
                        data: 'customer_credit_type',
                        name: 'customer_credit_type'
                    },
                    {
                        className: 'dt-body-center',
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    $(api.column(7).footer()).html(total_2.toFixed(2));
