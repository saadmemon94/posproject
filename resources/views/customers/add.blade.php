    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('customer.store', ['customer' => 1,]) }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('post')
                        ...
                        <div class="row">
                          <div class="col-6">
                            ...
                            <div class="row">
                              <div class="col-xs-12 col-md-6 pr-1">
                                <div class="form-group">
                                    <label for="type" class="col-sm-2 col-md-10 control-label">&nbsp;&nbsp;{{__(" Customer Type")}}</label>
                                    <div class="col-sm-10 col-md-12">
