            ...
            <table class="table-bordered">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;"></th>
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;">
                            {{ number_format((float) $supplier_data->previous, 2, '.', '') }}</th>
                    ...
                    {{-- <tr>
                        ...
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;"></th>
                        <th colspan="2" class="mycol form-col-2" style="text-align:left">
                            {{ number_format((float) $supplier_data->previous + ($purchase_data->purchase_grandtotal_price - $supplier_data->previous), 2, '.', '') }}
                        </th>
                    ...
                    <tr>
                        ...
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;"></th>
                        <th colspan="2" class="mycol form-col-2" style="text-align:left">
                            {{ number_format((float) $purchase_data->purchase_amount_received, 2, '.', '') }}</th>
                    </tr>
                    <tr>
                        ...
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;"></th>
                        <th colspan="2" class="mycol form-col-2" style="text-align:left">
                            {{ number_format((float) ($supplier_data->previous - $purchase_data->purchase_amount_received) /*+($purchase_data->purchase_amount_dues)*/, 2, '.', '') }}
                        </th>
