                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body-custom">
                            <form id="purchase_store" method="post" action="{{ route('purchase.store') }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12 input-group">
                                                                ...
                                                                <input readonly type="number" name="purchase_amount_paid"
                                                                    id="supplier_balance_paid" class="form-control col-12"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12 input-group">
                                                                ...
                                                                <input readonly type="number" name="purchase_amount_dues"
                                                                    id="supplier_balance_dues" class="form-control col-12"
                                                                    value="">
                                                                @include('alerts.feedback', ['field' =>
                                                    ...
                                                    <div class="form-first-col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12">
                                                                ...
                                                                <select id="purchase_payment_method"
                                                                    ...
                                                                    <tr class="row table-info">
                                                                        <td class="col-2 firstcol" scope="col">
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="Barcode Search/Scan" value="">
                                                                        </td>
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                ...
                                                                                value="0">
                                                                            <input type="hidden"
                                                                                name="purchase_pieces_per_packet_i"
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                ...
                                                                                value="0">
                                                                            <input type="hidden"
                                                                                name="purchase_packets_per_carton_i"
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                ...
                                                                                value="0">
                                                                            <input type="hidden"
                                                                                name="purchase_pieces_per_carton_i"
