                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body-custom">
                            <form id="purchasereturn_store" method="post" action="{{ route('purchase.storereturn') }}"
                                                    ...
                                                    <div class="form-first-col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12 input-group ">
                                                                ...
                                                                <input readonly type="hidden" name="purchase_supplier_name"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12 input-group">
                                                                ...
                                                                <input readonly type="number" name="purchase_amount_paid"
                                                                    ...
                                                                    value="{{ old('purchase_amount_paid', '') }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12 input-group">
                                                                ...
                                                                <input readonly type="number" name="purchase_amount_dues"
                                                                    ...
                                                                    value="{{ old('purchase_amount_dues', '') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                    ...
                                                    <div class="form-first-col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12">
                                                                ...
                                                                <select required id="purchase_payment_method"
                                                                ...
                                                                <tbody class="purchase-product">
                                                                    <tr class="row table-info">
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                name="purchase_products_pieces_i"
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                class="form-control col-12" min="0"
                                                                                value="{{ old('purchase_pieces_per_packet_i', '1') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                name="purchase_products_packets_i"
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                class="form-control col-12" min="0"
                                                                                value="{{ old('purchase_packets_per_carton_i', '1') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                name="purchase_products_cartons_i"
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                class="form-control col-12" min="0"
                                                                                value="{{ old('purchase_pieces_per_carton_i', '1') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                name="purchase_products_discount_i"
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input readonly type="number"
                                                                                name="purchase_products_sub_total_i"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="col-12">
                                                    ...
                                                    <input type="hidden" name="packets_per_carton" id="packets_per_carton"
                                                        ...
                                                        <div class="row">
                                                            <div class=" col-12 ">
                                                                <div class="search-box form-group">
                                                                    <label for="product_code_name"
                                                                        class=" col-10 control-label">&nbsp;&nbsp;{{ __(' Search Product') }}</label>
                                                                    <div class=" col-12 input-group ">
                                                                        <div class="input-group-prepend">
                                                                            <span class="input-group-text barcode">
                                                                                <a class="" data-toggle=" modal"
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach ($products as $key => $value)
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>{{ $value->product_barcode }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_pieces_available }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_packets_available }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_cartons_available }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_trade_price_piece }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_trade_price_packet }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_trade_price_carton }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_cash_price_piece }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_cash_price_packet }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_cash_price_carton }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_credit_price_piece }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_credit_price_packet }}
                                                                                            </td>
                                                                                            <td>{{ $value->product_credit_price_carton }}
                                                                                            </td>
                                                                                            <!-- <td>{ $value->product_nonbulk_price_piece }}</td> -->
                                                                                            <td class="text-right">
                                                                                                <a type="button"
                                                                                                    href="{{ route('product.edit', ['product' => $value->product_id]) }}"
                                                                                                    rel="tooltip"
