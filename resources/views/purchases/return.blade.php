  ...
  $(document).ready(function() {
    var dt = $('#purchasereturnTable').DataTable({
        ...
        columns: [
            ...
            { className: 'dt-body-center', data: 'purchase_return_total_items', name: 'purchase_return_total_items' },
            { className: 'dt-body-center', data: 'purchase_return_total_quantity', name: 'purchase_return_total_quantity' },
            ...
            { {{-- width:'25%', --}} className: 'dt-body-center', data: 'purchase_return_invoice_id', name: 'purchase_return_invoice_id' },
            { {{-- width:'25%', --}} className: 'dt-body-center', data: 'purchase_return_invoice_date', name: 'purchase_return_invoice_date' },
