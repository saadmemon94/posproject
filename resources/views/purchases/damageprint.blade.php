            ...
            <table class="table-bordered">
                <thead class="thead-dark-custom">
                    <tr class="row">
                        ...
                        <th colspan="3" class="mycol form-col-2" style="text-align:left">
                            <strong>{{ __('Product Damage') }}</strong>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <?php $total_quantity_damage = 0; ?>
                    @foreach ($products as $product)
                        ...
                        <tr class="row">
                            ...
                            <td colspan="3" class="mycol form-col-2" style="text-align:left;">
                                {{ number_format((int) $product_quantity_damage) . 'pcs' }}
                            </td>
                            <?php $total_quantity_damage += $product_quantity_damage; ?>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr class="row">
                        ...
                        <th colspan="3" class="mycol form-col-2" style="text-align:left;">
                            {{ number_format((int) $total_quantity_damage) }}{{ __('pcs') }}
                        </th>
                    </tr>
                </tfoot>
            </table>
