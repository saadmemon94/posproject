                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body-custom">
                            <form id="payment_store" method="post" action="{{ route('purchase.paymentadd') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="form-first-col-4">
                                                        <div class="form-group">
                                                            <label for="supplier_code"
                                                                class="form-col-10 control-label">&nbsp;&nbsp;{{ __(' Search Supplier') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                ...
                                                                <input readonly type="hidden" name="payment_supplier_name"
                                                                    id="supplier_name" placeholder="Supplier Name"
                                                                    class="form-control col-12" value="" />
                                                                <input readonly type="hidden" name="payment_supplier_id"
                                                                    id="supplier_id" class="form-control col-12" value="" />
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="supplier_amount_recieved"
                                                                class="form-col-12 control-label">{{ __('Supplier Recieve') }}</label>
                                                            <div class="form-col-12 input-group">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input readonly type="number"
                                                                    ...
                                                                    id="supplier_balance_recieved" class="form-control"
                                                                    value="{{ old('supplier_amount_recieved', '') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                                'supplier_amount_recieved'])
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-last-col-3">
                                                        <div class="form-group">
                                                            <label for="supplier_amount_dues"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __('Supplier Dues') }}</label>
                                                            <div class="form-col-12 input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text rs">Rs: </span>
                                                                </div>
                                                                <input readonly type="number" name="supplier_amount_dues"
                                                                    id="supplier_balance_dues" class="form-control"
                                                                    value="{{ old('supplier_amount_dues', '') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                                'supplier_amount_dues'])
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="payment_invoice_id"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Payment Invoice No.') }}</label>
                                                            <div class="form-col-12">
                                                                <div class="myrow">
                                                                    <input readonly type="text" name="payment_invoice_id"
                                                                        class="form-control form-col-12"
                                                                        value="{{ old('payment_invoice_id', $payment_invoice_id) }}">
                                                                </div>
                                                                @include('alerts.feedback', ['field' =>
                                                                'payment_invoice_id'])
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-first-col-3">
                                                        <div class="form-group">
                                                            <label for="payment_cheque_no"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Cheque No.') }}</label>
                                                            <div class="form-col-12">
                                                                <input type="text" name="payment_cheque_no"
                                                                    id="payment_cheque_no" class="form-control form-col-12"
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="payment_cheque_date"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Cheque Date') }}</label>
                                                            <div class="form-col-12">
                                                                <input type="date" name="payment_cheque_date"
                                                                    id="payment_cheque_date"
                                                                    class="form-control form-col-12"
                                                                    value="{{ old('payment_cheque_date', '') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                                'payment_cheque_date'])
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="purchase_invoice_id"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Purchase Invoice No.') }}</label>
                                                            <div class="form-col-12">
                                                                <div class="myrow">
                                                    ...
                                                    <div class="form-last-col-3">
                                                        <div class="form-group">
                                                            <label for="payment_amount_paid"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Paid Amount') }}</label>
                                                            <div class="form-col-12 input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text rs">Rs: </span>
                                                                </div>
                                                                <input type="text" name="payment_amount_paid"
                                                                    id="payment_amount_paid"
                                                                    class="form-control form-col-12"
                                                                    value="{{ old('payment_amount_paid', '0') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                                'payment_amount_paid'])
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-first-col-2">
                                                        <div class="form-group">
                                                            <label for="payment_account_no"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Account #') }}</label>
                                                            <div class="form-col-12">
                                                                <input type="text" name="payment_account_no"
                                                                    id="payment_account_no" class="form-control form-col-12"
                                                                    value="{{ old('payment_account_no', '') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                                'payment_account_no'])
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-last-col-10">
                                                        <div class="form-group">
