                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-info btn-round text-white pull-right"
                                href="{{ route('supplier.create') }}">{{ __('Add Supplier') }}</a>
            ...
            var dt = $('#supplierTable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: 'supplier_shop_name'
                    },
                    {
                        className: 'dt-body-center',
                        data: 'supplier_shop_info',
                        name: 'supplier_shop_info'
                    },
                    {
                        className: 'dt-body-center',
                        data: 'supplier_town',
                    ...
                    {
                        className: 'dt-body-center',
                        data: 'supplier_balance_paid',
                        name: 'supplier_balance_paid'
                    },
                    {
                        className: 'dt-body-center',
                        data: 'supplier_balance_dues',
                        name: 'supplier_balance_dues'
                    },
                    {
                        className: 'dt-body-center',
                        data: 'action',
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    $(api.column(8).footer()).html(total_1.toFixed(2));
                    $(api.column(9).footer()).html(total_2.toFixed(2));
