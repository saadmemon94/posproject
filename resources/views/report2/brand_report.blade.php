                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header ">
                            <h3 class="text-center">{{'Brand Report'}}</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="card-body-custom col-12 ">
                                    <div class="row">
                                        ...
                                        <div class="col-4 ">
                                            <div class="form-group">
                                                <label><strong>{{'Choose Brand'}}</strong> &nbsp;</label>
                                                <div class="input-group">
                                                    <input type="hidden" name="brand_id_hidden" value="{{$brand_name}}" />
                                                    <select id="brand_name" name="brand_name" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins">
                                                ...
                                                <table id="sale-table" class="table table-sm table-striped table-bordered dataTable display compact hover order-column" cellspacing="0" width="1000px" style="width: 1000px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            {{-- <td>
                                                                @if (!empty($product_sale_data[$key]))
                                                                    @foreach($product_sale_data[$key] as $one_product_sale_data)
                                                                    <?php
                                                                        $product = App\Models\Product::where('product_id', $one_product_sale_data->product_id)->select('product_name')->get()->toArray();
                                                                    ?>
                                                                    {{$product[0]['product_name'].' ('.$one_product_sale_data->sale_quantity_total.')'}}
                                                                    <br>
                                                                    @endforeach
                                                                @endif
                                                            </td> --}}
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $('#brand_name').val($('input[name="brand_id_hidden"]').val());
