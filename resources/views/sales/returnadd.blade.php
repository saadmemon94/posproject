                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body-custom">
                            <form method="post" action="{{ route('sale.storereturn') }}" autocomplete="off"
                            ...
                            <div class="form-col-12 input-group ">
                              ...
                              @include('alerts.feedback', ['field' => 'sale_customer_name'])
                                                ...
                                                <div class="row">
                                                    <div class="form-first-col-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12">
                                                                ...
                                                                <select required id="sale_payment_method"
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="sale_invoice_id"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __('Sale Invoice ID') }}</label>
                                                            <div class="form-col-12">
                                                                <div class="myrow">
                                                                    {{-- <div class="col-1"></div> --}}
                                                                    <input type="text" name="sale_invoice_id"
                                                                        class="form-control form-col-12"
                                                                        value="{{ old('sale_invoice_id', '') }}">
                                                                </div>
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="sale_invoice_date"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __(' Return Date') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                {{-- <div class="input-group-prepend">
                                <span class="input-group-text barcode"><i class="fa fa-file-text-o"></i></span>
                              </div> --}}
                                                                <input type="date" name="sale_invoice_date"
                                                                    class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12">
                                                                <input readonly type="text" name="payterm_duratype"
                                                                    ...
                                                                    value="{{ old('payterm_duratype', '0 Days') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-last-col-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class=" form-col-12">
                                                                <input readonly type="number" name="customer_credit_limit"
                                                                    ...
                                                                    value="{{ old('customer_credit_limit', '0') }}">
                                                                        ...
                                                                        <td class="col-3 mycol" scope="col">
                                                                            <div class="col-12 mytblcol input-group">
                                                                                ...
                                                                                <input type="hidden"
                                                                                    ...
                                                                                    id="product_company_i"
                                                                                    value="{{ old('product_company_i', '') }}">
                                                                                <input type="hidden" name="product_brand_i"
                                                                                    id="product_brand_i"
                                                                                    value="{{ old('product_brand_i', '') }}">
                                        ...
                                        @endforeach
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                                ...
                                                                                class="form-control col-12" min="0" max=""
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                value="{{ old('sale_pieces_per_packet_i', '1') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                class="form-control col-12" min="0"
                                                                                value="{{ old('sale_packets_per_carton_i', '1') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number"
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                class="form-control col-12" min="0"
                                                                                value="{{ old('sale_pieces_per_carton_i', '1') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            ...
                                                                            <input readonly type="hidden"
                                                                                ...
                                                                                id="sale_products_packet_price_i" value="0">
                                                                            <input readonly type="hidden"
                                                                                name="sale_products_carton_price_i"
                                                                                id="sale_products_carton_price_i" value="0">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="text"
                                                                        ...
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input readonly type="text"
                                                                                ...
                                                                                class="form-control col-12"
                                                                                value="{{ old('sale_products_sub_total_i', '0') }}">
                                                                        </td>
                                                                ...
                                                                <tfoot class="thead-dark">
                                                                    <tr class="row">
                                                                        ...
                                                                        <th class="col-2 lastcol" scope="col">Recieved
                                                                            Change</th>
                                                                    </tr>
                                                                    <tr class="row table-info">
                                                                        {{-- <td class="col-1 mycol" scope="col">
                                  ...
                                  <td class="col-3 midcol" scope="col">
                                    ...
                                    <input type="file" name="sale_document" id="sale_document" class="form-control col-12" value="{{ old('sale_document', '') }}">
                                                                        ...
                                                                        {{-- <td class="col-2 mycol" scope="col">
                                                                            <select name="sale_payment_status"
                                                                                class="selectpicker form-control col-12"
                                                                    ...
                                                                    <tr class="row table-info">
                                                                        ...
                                                                        <td class="col-2 mycol" scope="col">
                                                                            <input readonly type="number"
                                                                                ...
                                                                                id="sale_total_price"
                                                                                class="form-control col-12"
                                                                                value="{{ old('sale_total_price', '0') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input type="number" name="sale_add_amount"
                                                                                id="sale_add_amount"
                                                                                class="form-control col-12"
                                                                                value="{{ old('sale_add_amount', '0.00') }}">
                                                                        </td>
                                                                        <td class="col-1 mycol" scope="col">
                                                                            <input readonly type="number"
                                                                                name="sale_discount" id="sale_discount"
                                                                                class="form-control col-12"
                                                                                value="{{ old('sale_discount', '0') }}">
                                                                        </td>
                                                                        <td class="col-2 mycol" scope="col">
                                                                            <input readonly type="number"
                                                                                ...
                                                                                class="form-control col-12"
                                                                                value="{{ old('sale_grandtotal_price', '0') }}">
                                                                        </td>
                                                                        <td class="col-2 lastcol" scope="col">
                                                                            <input type="number" name="sale_amount_returned"
                                                                                id="sale_amount_returned"
                                                                                class="form-control col-12"
                                                                                value="{{ old('sale_amount_returned', '0') }}">
                                                                        </td>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
        ...
        function productSearch(data) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var maxproduct_pieces =
                        catchproduct_pieces; //+(catchproduct_cartons*pieces_per_carton)+(catchproduct_packets*pieces_per_packet);
        ...
        function productSearch3(data) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var netcartons = catchproduct_cartons - sale_products_cartons;
                    var maxproduct_pieces = catchproduct_pieces + (netpackets * pieces_per_packet) + (
                        netcartons * pieces_per_carton);
