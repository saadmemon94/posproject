        ...
        <div id="receipt-data">
            ...
            <table class="table-bordered">
                ...
                <tbody>
                    ...
                    @foreach ($sale_products_data as $sale_product)
                        ...
                        $sale_product_punch_time = $sale_product->sale_product_punch_time;
                        ?>
                        <tr class="row">
                            <td colspan="6" class="mycol form-col-6" style="text-align:left;">
                                {{ $product_name }}
                                {{-- $product_name.'<'.$sale_product_punch_time.'>' --}}
                            </td>
                ...
                <tfoot>
                    <tr class="row">
                        ...
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;">
                            {{ number_format((float) $sale_data->sale_discount, 2, '.', '') }}
                        </th>
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;">
                            |{{ number_format((float) $sale_data->sale_grandtotal_price, 2, '.', '') }}|
                        </th>
                    </tr>
                    ...
                    {{-- <tr>
                        ...
                        <th colspan="2" class="mycol form-col-2" style="text-align:left;"></th>
                        <th colspan="2" class="mycol form-col-2" style="text-align:left">
                            {{ number_format((float) $sale_data->sale_amount_dues /*+ $sale_data->sale_grandtotal_price*/ /*- $sale_data->sale_amount_recieved*/ /*+($sale_data->sale_amount_dues)*/, 2, '.', '') }}
                        </th>
                        {{ /* number_format((float)($customer_data->customer_balance_dues) //+($sale_data->sale_amount_dues),2,'.','') */ }}
                    </tr> --}}
                </tfoot>
            </table>
            @if ($sale_products_delete->isEmpty())
            @else
                <table class="table-bordered">
                    <thead class="thead-dark-custom">
                        <tr class="row">
                            <th colspan="6" class="mycol form-col-6" style="text-align:left">
                                <strong>{{ __('Product Return') }}</strong>
                            </th>
                            <th colspan="2" class="mycol form-col-2" style="text-align:left">
                                <strong>{{ __('Qty') }}</strong>
                            </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($sale_products_delete as $sale_product_return)
                            <?php
                            $product_data = \App\Models\Product::where('product_id',
                            $sale_product_return->product_id)->first();
                            $product_name = $product_data->product_name;
                            $sale_quantity_all += $sale_product_return->sale_quantity_total;
                            // $unit_price_all += number_format((float)($sale_product->sale_product_sub_total /
                            $sale_product_return->sale_quantity_total;
                            $sale_packets_number = $sale_product_return->sale_packets_number;
                            $sale_cartons_number = $sale_product_return->sale_cartons_number;
                            $sale_pieces_number = $sale_product_return->sale_pieces_number;
                            ?>
                            <tr class="row">
                                <td colspan="6" class="mycol form-col-6" style="text-align:left;">
                                    {{ $product_name }}
                                ...
                                {{-- {{number_format((float)($sale_product_return->sale_product_sub_total / $sale_product_return->sale_quantity_total), 2, '.', '')}} --}}
                                <td colspan="2" class="mycol form-col-2" style="text-align:left;">
                                    {{ number_format((float) $sale_product_return->sale_trade_discount, 2, '.', '') }}
                                </td>
                                <td colspan="2" class="mycol form-col-2" style="text-align:left;">
                                    |{{ number_format((float) $sale_product_return->sale_product_sub_total /**$sale_product_return->sale_quantity_total*/, 2, '.', '') }}|
                                </td>
                                <?php
                                $total_sale_quantity += $sale_product_return->sale_quantity_total;
                                $total_return_amount += $sale_product_return->sale_product_sub_total;
                                ?>
                            </tr>
                        @endforeach
                    ...
                    <tfoot>
                        <tr class="row">
                            ...
                            <th colspan="2" class="mycol form-col-2" style="text-align:left;">
                                |{{ number_format((float) $total_return_amount, 2, '.', '') }}|
                            </th>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="centered" style="margin:0px 0 50px">
                <p class="text-lowercase">
                    {{ __('Remarks: ') }}{{ $sale_data->sale_note }}
                </p>
                <p class="text-lowercase">
