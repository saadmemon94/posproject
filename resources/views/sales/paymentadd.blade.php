                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __(' Add Sale Payment') }}</h5>
                        </div>
                        <div class="card-body-custom">
                            <form id="payment_store" method="post" action="{{ route('sale.paymentadd') }}"
                                                            ...
                                                            <div class="form-col-12 input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text barcode">
                                                                        <a class="___class_+?21___" data-toggle="modal"
                                                                ...
                                                                <input type="text" id="customercodesearch"
                                                                    name="customer_code"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12">
                                                                <div class="myrow">
                                                                    <input readonly type="text" id="payment_invoice_id"
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="sale_invoice_id"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __('Sale Invoice No.') }}</label>
                                                            <div class="form-col-12">
                                                                <div class="myrow">
                                                                    <input type="text" id="sale_invoice_id"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-col-12 input-group">
                                                                ...
                                                                <input type="file" name="payment_document"
                                                                    id="payment_document" class="form-control col-12"
                                                    ...
                                                    <div class="form-last-col-3">
                                                        <div class="form-group">
                                                            <label for="payment_amount_recieved"
                                                                class="form-col-12 control-label">&nbsp;&nbsp;{{ __('Recieved Amount') }}</label>
                                                            <div class="form-col-12 input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text rs">Rs: </span>
                                                                </div>
                                                                <input type="number" id="payment_amount_recieved"
                                                                    name="payment_amount_recieved"
                                                                    class="form-control form-col-12"
                                                                    value="{{ old('payment_amount_recieved', '0') }}">
                                                                @include('alerts.feedback', ['field' =>
                                                                'payment_amount_recieved'])
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
