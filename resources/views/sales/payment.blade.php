                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-info btn-round text-white pull-right"
                                href="{{ route('sale.paymentcreate') }}">{{ __(' Add Sale Payment') }}</a>
                            <h4 class="card-title">{{ __(' Sale Payment List') }}</h4>
                            <div class="col-12">
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="paymentTable"
                                ...
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th colspan="1" class="text-center">Cust Info</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">Sale Inv.No</th>
