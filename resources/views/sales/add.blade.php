    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('sale.store', ['sale' => 1,]) }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('post')
                ...
                <div class="row">
                  <div class="card-body col-12 ">
                    <fieldset class="col-md-12 border p-1 ">
                      <legend class="w-auto">Sale:</legend>
                        <div class="row">
                        </div>
                        <div class="row">
                          <div class="col-6">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12 col-md-6 pr-1">
                                  <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-10 control-label">&nbsp;&nbsp;{{__(" Customer Name")}}</label>
                                    <div class="col-sm-10 col-md-12">
                            ...
                            <div class="row">
                              <div class="col-xs-12 col-md-6 pr-1">
                                  <div class="form-group">
                                    <label for="status" class="col-sm-2 col-md-8 control-label">&nbsp;&nbsp;{{__(" Sale Status")}}</label>
                                      <div class="col-sm-10 col-md-12">
                          ...
                          <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12 pr-2">
                                    <div class="form-group">
                                        <label for="date" class="col-sm-2 col-md-6 control-label">&nbsp;&nbsp;{{__(" Sale Note")}}</label>
                                        <div class="col-sm-10 col-md-12">
