                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-info btn-round text-white pull-right"
                                href="{{ route('sale.returnadd') }}">Add Sale Return</a>
    ...
    <script>
        var dt = $('#salereturnTable').DataTable({
            ...
            columns: [{
                ...
                {
                    className: 'dt-body-center',
                    data: 'sale_return_ref_no',
                    name: 'sale_return_ref_no'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_status',
                    name: 'sale_return_status'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_total_items',
                    name: 'sale_return_total_items'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_total_quantity',
                    name: 'sale_return_total_quantity'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_grandtotal_price',
                    name: 'sale_return_grandtotal_price'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_amount_return',
                    name: 'sale_return_amount_return'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_amount_dues',
                    name: 'sale_return_amount_dues'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_payment_method',
                    name: 'sale_return_payment_method'
                },
                {
                    className: 'dt-body-center',
                    data: 'sale_return_payment_status',
                    name: 'sale_return_payment_status'
                },
                {
                    {{-- width:'25%', --}} className: 'dt-body-center',
                    data: 'sale_return_invoice_id',
                    name: 'sale_return_invoice_id'
                },
                {
                    {{-- width:'25%', --}} className: 'dt-body-center',
                    data: 'sale_return_invoice_date',
                    name: 'sale_return_invoice_date'
                },
                {
                    {{-- width:'25%', --}} className: 'dt-body-center',
                    data: 'name',
