@extends('layouts.app', [
    ...
    'activePage' => 'login',
    'backgroundImage' => asset('assets') . "/img/POS1_.jpg",
])
            ...
            <div class="card card-login card-plain">
                <div class="card-header ">
                    {{-- <div class="logo-container">
                        <img src="{{ asset('assets/img/alsyedstorelogo2.png') }}" alt="">
                    </div> --}}
                    <center>
                        <div class="logo">
                ...
                <div class="card-body ">
                    <div class="input-group no-border form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}">
                        ...
                        <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="text" name="email" value="{{ old('email', 'superadmin') }}" required autofocus>
                    </div>
                    @if ($errors->has('email'))
                    ...
                    <button  type = "submit" class="btn btn-info btn-round btn-lg btn-block mb-3">{{ __('Get Started') }}</button>
                    {{-- <div class="pull-left">
                        <h6>
