    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('brand.store', ['brand' => 1,]) }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('post')
                ...
                <div class="row">
                  <div class="col-md-4 pr-1">
                      <div class="form-group">
                          <label>{{__(" Name")}}</label>
                              <input type="text" name="name" class="form-control" placeholder="Brandy Name" value="{{ old('name', '') }}">
                ...
                <div class="row">
                  <div class="col-md-12 pr-1">
                    <div class="form-group">
                      ...
                      <textarea type="text" rows="3" id="description" name="description" class="form-control" placeholder="Brand Description" value="{{ old('description', '') }}"></textarea>
                      {{-- <input type="text" id="description" name="description" class="form-control" placeholder="Brand Description" value="{{ old('description', '')}}"> --}}
