        ...
        <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <fieldset class="form-group">
                ...
                <select class="form-control" data-placeholder="Your Favorite Football Team" id="select2-3">
                  <option value=""></option>
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-actions">
                <a href="http://www.daterangepicker.com">
                  <small class="text-muted">docs</small>
                </a>
              </div>
            </div>
...
@section('javascript')
    ...
    <script src="{{ asset('js/coreui/min/jquery.maskedinput.min.js') }}"></script>
    <script src="{{ asset('js/coreui/min/moment.min.js') }}"></script>
    <script src="{{ asset('js/coreui/min/select2.min.js') }}"></script>
    <script src="{{ asset('js/coreui/min/daterangepicker.min.js') }}"></script>

    <!-- Custom scripts required by this view -->
    {{-- <script src="{{ asset('js/coreui/advanced-forms.js') }}"></script> --}}
@endsection