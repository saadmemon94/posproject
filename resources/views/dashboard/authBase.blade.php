...
<html lang="en">
  ...
  <body class="c-app flex-row align-items-center">
    {{-- <div class="c-wrapper wrapper-full-page "> --}}
      <div class="full-page register-page section-image" filter-color="black" data-image="{{ asset('assets/img/POS-Cashier-1.jpg') }}" style="background-image: url('{{ asset('assets/img/POS-Cashier-1.jpg')}}');">
        @yield('content') 
      </div>
    {{-- </div> --}}
