                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="user_update" method="POST"
                                action="{{ route('users.update', ['user' => $user->id]) }}" autocomplete="off">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="password"
                                                                class=" col-12 control-label">&nbsp;&nbsp;{{ __(' New Password') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text barcode">
                                                                ...
                                                                <input class="form-control col-12" type="password"
                                                                    minlength="6" placeholder="{{ __(' New Password') }}"
                                                                    name="password" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-last-col-3">
                                                        <div class="form-group">
                                                            <label for="password_confirmation"
                                                                class=" col-12 control-label">&nbsp;&nbsp;{{ __(' New Confirm Password') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text barcode">
                                                                        <a class="" id=" user-list-btn">
                                                                ...
                                                                <input class="form-control col-12" type="password"
                                                                    minlength="6"
                                                                    placeholder="{{ __(' New Confirm Password') }}"
