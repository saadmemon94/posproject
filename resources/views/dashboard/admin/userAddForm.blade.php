                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> {{ __('Add User') }}
                        </div>
                        <div class="card-body">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="form-first-col-3">
                                                        <div class="form-group">
                                                            <label for="name"
                                                                class=" col-12 control-label">&nbsp;&nbsp;{{ __(' Full Name') }}</label>
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="name"
                                                                class=" col-12 control-label">&nbsp;&nbsp;{{ __(' Username') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text barcode">
                                                                        <a class="" id=" user-list-btn"><i
                                                                                class="fa fa-user"></i></a>
                                                                    </span>
                                                                </div>
                                                                <input required class="form-control col-12" type="text"
                                                    ...
                                                    <div class="form-col-3">
                                                        <div class="form-group">
                                                            <label for="password"
                                                                class=" col-12 control-label">&nbsp;&nbsp;{{ __(' Password') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text barcode">
                                                                ...
                                                                <input required class="form-control col-12" type="password"
                                                                    minlength="6" placeholder="{{ __('Password') }}"
                                                    ...
                                                    <div class="form-last-col-3">
                                                        <div class="form-group">
                                                            <label for="password_confirmation"
                                                                class=" col-12 control-label">&nbsp;&nbsp;{{ __(' Confirm Password') }}</label>
                                                            <div class="form-col-12 input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text barcode">
                                                                        <a class="" id=" user-list-btn">
                    ...
                    <a href="{{ route('users.index') }}" class="btn btn-block btn-primary">{{ __('Back') }}</a> --}}
                                <div class="card-footer row">
                                    <div class="col-6">
                                        <button type="submit"
                                            class="btn btn-info btn-round pull-left">{{ __('Save') }}</button>
                                    </div>
                            </form>
                            <div class="col-6">
