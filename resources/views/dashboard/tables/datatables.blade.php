...
@section('javascript')
    ...
    {{-- <script src="{{ asset('js/coreui/min/pace.min.js') }}"></script> --}}

    <!-- Plugins and scripts required by this views -->
    <script src="{{ asset('js/coreui/min/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('js/coreui/min/dataTables.bootstrap4.min.js') }}"></script>
